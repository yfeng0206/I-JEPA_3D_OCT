...
diagnosis. We test that intuition from one shared ancestor checkpoint under a
matched schedule and probe protocol. Six
...
\item The subgroup ordering survives every policy tried, and the headline result
