...
\midrule
\textsc{anatomy-v2} & segmenter (target shape) & \AUCAnatomyTwoEpFifty & \DAnatomyTwoRandomEpFifty & \AUCAnatomyTwoEpSeventyFive & \DAnatomyTwoRandomEpSeventyFive & \AUCAnatomyTwoEpHundred & \DAnatomyTwoRandomEpHundred \\
\textsc{cover} $f{=}.21$ & segmenter (coverage) & \AUCCoverEpFifty & \DCoverRandomEpFifty & \AUCCoverEpSeventyFive & $\mathbf{\DCoverRandomEpSeventyFive}\CoverDagEpSeventyFive$ & \AUCCoverEpHundred & \DCoverRandomEpHundred \\
\bottomrule
\end{tabular}
\end{table}
