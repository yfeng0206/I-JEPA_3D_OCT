...
carried further falls below it by epoch 75 (interval excluding zero), while
...
\textsc{envelope}'s \emph{policy} differs from the unguided null in location
alone (Section~\ref{sec:policies}), though aiming makes the rectangles overlap,
so delivered context moves with it ($24.7\%$ to $30.7\%$,
Table~\ref{tab:delivered}). Moving the same rectangles onto tissue is worth
