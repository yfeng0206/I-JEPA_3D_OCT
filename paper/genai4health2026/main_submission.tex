...
analysis and the reasons. Protocol is identical throughout except where the
precision column says otherwise: FairVision test $N{=}\Ntest$, seed 42, frozen
encoder, MeanPool + LayerNorm + Linear. ``Precision'' is the probe-time
