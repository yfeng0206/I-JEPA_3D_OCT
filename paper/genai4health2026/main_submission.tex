...
model, while shaping targets to trace the segmented retina matched unguided
...
\Nboot-resample percentile bootstrap intervals over test volumes, with the
...
positive and passes multiplicity correction at
...
by test AUC. Reported separately from frozen probes and never pooled with
them.}
\label{tab:finetuned}
\small
\begin{tabular}{llc}
