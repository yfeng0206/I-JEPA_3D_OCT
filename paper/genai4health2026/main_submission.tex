...
is the mask sampler; the anatomy family additionally differs in collation, and
...
anatomy arms exceed \textsc{envelope}. Tested directly at epoch 50 --- the only
epoch at which all five arms have a probe --- \textsc{anatomy-v2} sits
...
Table~\ref{tab:main} to within $0.0003$.
...
observation. The absolute gains at full supervision are small, but
the regime that matters for a new imaging site or a rare condition is the one
with few labels. Appendix~\ref{app:labeleff} gives the full curve.
