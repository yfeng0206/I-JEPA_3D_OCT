...
examined. Three attributes survive correction at checkpoint level: sex and
disease severity, both of which \emph{narrow} as aggregate AUC rises, and race,
which widens. Race is the one attribute whose checkpoint-level trend does not
