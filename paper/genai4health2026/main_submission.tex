...
continuation, Appendix~\ref{app:excluded}); we stopped that arm after epoch 75,
because it had already moved from indistinguishable-from-null at epoch 50 to
significantly below it at epoch 75 and a further 25 epochs would have deepened an
established deficit rather than tested anything new.
