...
so unlike a truncated AUC axis it cannot exaggerate the spacing. Filled markers
...
Section~\ref{sec:results-h3} develops. Per-arm error bars are drawn nowhere in
this paper, because between-case variance cancels in a pairing and would
understate the evidence. Companion to Figure~\ref{fig:paradox}.}
\label{fig:ladder}
\end{figure}
